const canvas = document.getElementById('queijoCanvas');
...
const appleImageUrl = 'img/queijof.png'; // Altere para o nome e caminho do seu arquivo de imagem
...
// Construtor para uma "maçã" individual
function Apple() {
